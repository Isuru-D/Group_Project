...
<body>
    <div class="container">
		...
		<div class="navbar">
					...
					<a href="Acc_home.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a>
  					<a href="ACC_paymentHistoryPage.php"><i class="fa fa-history" aria-hidden="true"></i>Payment History</a>
                      <a href="Accountant_ReportGeneration.php"><i class="fa fa-file" aria-hidden="true"></i>Reports</a>
					<a href="ACC_SECollectionsPage.php"><i class="fa fa-money" aria-hidden="true">SE_Payments</i></a> 
