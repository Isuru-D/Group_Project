...
<?php
		if(isset($_POST['add'])) {
			...
			$sql = "INSERT INTO `spareparts_stock` (`itemNO`, `name`, `quantity`, `unitPrice`, `photo`,`category`) VALUES ('$item', '$name', '$quantity', '$price', '".$img."','momali')";
...
if(isset($_POST['search']))
{
    ...
    // mysql search query
    $query = "SELECT * FROM `spareparts_stock` WHERE `itemNo` = $id && `category`='momali' LIMIT 1";
...
// in the first time inputs are empty
	...
	$query1 = "SELECT * FROM spareparts_stock WHERE category='momali'";
...
if(isset($_POST['update'])){
    ...
    if($photoTmpPath != ""){
        ...
        $sqly = "UPDATE spareparts_stock SET name = '".$_POST['itemName']."',itemNo = '".$_POST['itemid']."',quantity = '".$_POST['quantity']."',unitPrice = '".$_POST['price']."', photo='$image' WHERE itemNo ='".$_POST['itemid']."' && category='momali'";
        $resulty = mysqli_query($connection,$sqly);
    } else{
        $sqly = "UPDATE spareparts_stock SET name = '".$_POST['itemName']."',itemNo = '".$_POST['itemid']."',quantity = '".$_POST['quantity']."',unitPrice = '".$_POST['price']."' WHERE itemNo ='".$_POST['itemid']."' && category='momali'";
        $resulty = mysqli_query($connection,$sqly);   
    }
  
    $sqlz = "SELECT * FROM spareparts_stock WHERE itemNo =".$_POST['itemid']." && category ='momali'";
...
if(isset($_POST['delete'])){
    ...
    $id = $_POST['itemid'];
    $sqly2 = "DELETE FROM `spareparts_stock` WHERE `itemNo` = $id && `category`='momali'";
...
<body>
    <div class="container">
		...
		<div class="navbar">
                    ...
                    <a href="OM_home.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a>
  				...
  				<div class="table-wrap">
    				<table class="main-table">
        					...
        					<tr>
								...
								<?php
								$sql = "SELECT * FROM spareparts_stock WHERE category='momali'";
