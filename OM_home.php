<html>
<head>
<title>OM Dash board</title>
<link rel="stylesheet" type="text/css" href="./css/OMhome.css">
...
<body>
	...
	<div class="container">
		<div class= "op1">
			...
			<img src="./img/ap_orders.png" height="60%" width="60%">
		</div>
		<div class= "op2">
			<h3>ITEM STOCK</h3>
			<img src="./img/stock.png" height="70%" width="70%">
		</div>
		<div class= "op3">
			<h3>SPARE PARTS STOCK</h3>
			<img src="./img/spare.png" height="55%" width="70%">
		</div>
		<div class= "op4">
			<h3>REPORT GENERATION</h3>
			<img src="./img/report.jpg" height="55%" width="80%">
		</div>
	</div>
	</div class="container">
		<div class="logo">
