<html>
<head>
<title>HOM Dash board</title>
<link rel="stylesheet" type="text/css" href="./css/HOMhome.css">
...
<body>
	...
	<div class="container">
		<div class= "op1">
			...
			<img src="./img/late_payment.png" height="60%" width="95%">
		</div>
		<div class= "op2">
			<h3>DEALER INFORMATION</h3>
			<img src="./img/deler_info.png" height="70%" width="70%">
		</div>
		<div class= "op3">
			<h3>ORDERS</h3>
			<img src="./img/orders.png" height="60%" width="60%">
		</div>
	</div>
	</div class="container">
		<div class="logo">
